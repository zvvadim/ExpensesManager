 ...
 */
public class ExpensesManagerPadLayout extends ViewGroup {

    private int mRowCount;
    private int mColumnCount;

    public ExpensesManagerPadLayout(Context context) {
        this(context, null);
    }

    public ExpensesManagerPadLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExpensesManagerPadLayout(Context context, AttributeSet attrs, int defStyle) {
