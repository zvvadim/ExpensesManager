...
public class ExpensesManagerExpressionBuilder extends SpannableStringBuilder {

    private final ExpensesManagerExpressionTokenizer mTokenizer;
    private boolean mIsEdited;

    public ExpensesManagerExpressionBuilder(
            CharSequence text, ExpensesManagerExpressionTokenizer tokenizer, boolean isEdited) {
        super(text);
