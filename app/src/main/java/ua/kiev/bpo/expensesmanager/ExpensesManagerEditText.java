...
public class ExpensesManagerEditText extends EditText {
    ...
    public ExpensesManagerEditText(Context context) {
        this(context, null);
    }

    public ExpensesManagerEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExpensesManagerEditText(Context context, AttributeSet attrs, int defStyle) {
