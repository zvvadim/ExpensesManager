...
public class ExpensesManagerPadViewPager extends ViewPager {
    ...
    public ExpensesManagerPadViewPager(Context context) {
        this(context, null);
    }

    public ExpensesManagerPadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
