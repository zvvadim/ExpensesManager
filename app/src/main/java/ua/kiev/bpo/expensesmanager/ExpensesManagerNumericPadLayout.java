...
public class ExpensesManagerNumericPadLayout extends ExpensesManagerPadLayout {

    public ExpensesManagerNumericPadLayout(Context context) {
        this(context, null);
    }

    public ExpensesManagerNumericPadLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExpensesManagerNumericPadLayout(Context context, AttributeSet attrs, int defStyle) {
